...
[RequireComponent(typeof(HitPoints))]
[DisallowMultipleComponent]
public class RangedAI : MonoBehaviour, IBulletDamagable
{
    [HideInInspector] public NavMeshAgent agent;
    [HideInInspector] public ViewCone vision;
    [HideInInspector] public HitPoints health;
    ...
    public float poiRandomizationRadius = 4f;
    public float stoppedMovingTimeThreshold = 0.5f;
    public float destinationMinDistance = 4f;
    public float tryKeepDistanceFromPlayer = 10f;
    public float playerSurroundRandomizeTime = 1f;
    public float surroundRandomizeRadius = 4f;

    public float attackCooldownMin = 0.1f;
    public float attackCooldownMax = 2f;
    public GameObject attackPrefab;
    public Transform attackFrom;
    public float playerPredictionSeconds = 0.3f;
    public float predictionDeltaSpeed = 3;
    public float randomTargetRadius = 1.5f;
    ...
    private const int REPEAT_FRAME_COUNT = 5;
