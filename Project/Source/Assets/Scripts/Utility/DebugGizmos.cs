...
// From: https://github.com/jagt/unity3d-runtime-debug-draw
...
#region Internal
	...
	/// </summary>
	private static RuntimeDebugDraw.Internal.DebugGizmos _rtDraw;
	...
	private static void CheckAndBuildHiddenRTDrawObject()
	{
		...
		_rtDraw = GameObject.FindObjectOfType<RuntimeDebugDraw.Internal.DebugGizmos>();
		if (_rtDraw != null)
			return;
		...
		_rtDraw = childGo.AddComponent<RuntimeDebugDraw.Internal.DebugGizmos>();
...
public static class DrawEditor
{
	static DrawEditor()
	{
		...
		var name = typeof(RuntimeDebugDraw.Internal.DebugGizmos).Name;
...
{
	internal class DebugGizmos : MonoBehaviour
	{
#region Basics
